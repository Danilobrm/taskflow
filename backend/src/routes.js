...
// router.post("/api/boards/:boardId/categories", categoryController.create.bind(categoryController));
// router.get("/api/boards/:boardId/categories", categoryController.list.bind(categoryController));
// router.get("/api/categories/:id", categoryController.get.bind(categoryController));
// router.put("/api/categories/:id", categoryController.update.bind(categoryController));
// router.delete("/api/categories/:id", categoryController.delete.bind(categoryController));

// Tasks (Tarefas)
router.post("/api/boards/:boardId/tasks", taskController.create.bind(taskController));
router.get("/api/boards/:boardId/tasks", taskController.listByBoard.bind(taskController));
